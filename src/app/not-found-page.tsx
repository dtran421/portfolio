...
import sadPeepoImg from "@/public/img/sad_peepo.png";
    ...
    <div className="w-full flex flex-col lg:flex-row justify-center xl:gap-x-20 gap-y-10 lg:gap-y-0">
        ...
        <div className="xl:w-2/3 space-y-6 px-10 md:px-0">
          <div className="mb-4">
            <div className="flex items-center space-x-3">
              <FiAlertTriangle size={36} className="text-yellow-500 dark:text-yellow-400 dark-transition" />
              <h1 className="text-3xl md:text-4xl font-bold">Uh oh!</h1>
            </div>
            <p className="md:text-lg font-medium">We couldn&apos;t find the page you were looking for!</p>
          </div>
          <Link href="/" passHref>
            <button
              type="button"
      ...
      <div className="relative flex justify-center items-center">
        <div className="overflow-hidden rounded-full shadow-inner mx-8 md:mx-0">
          <Image alt="sad peepo" src={sadPeepoImg} width={511} height={286} priority />
        </div>
        <motion.div
