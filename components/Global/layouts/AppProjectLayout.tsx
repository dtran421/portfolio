...
import Paragraph from "../../Projects/AppProject/Paragraph";

const MenuBar = dynamic(() => import("../../Projects/AppProject/MenuBar"), {
    ssr: false
});

const PhoneDemo = dynamic(() => import("../../Projects/AppProject/PhoneDemo"), {
    ssr: false
});
...
const AppProjectLayout = ({
    ...
    const [imgClass, setImgClass] = useState(
        "z-10 relative rounded-3xl opacity-0 transition duration-200 ease-linear"
    );
